...
// User-assigned identity configuration for stg
...
// Key Vault configuration for stg
param keyVault = {
  prefix: 'dummyfin'
  resourceIndex: '001'
  skuName: 'standard'
...
// Networking configuration for stg environment - with Application Gateway
param vnetApp = {
  prefix: 'app'
  resourceIndex: '001'
...
// DB VNet configuration for stg environment - peering enabled for production-like topology
param vnetDb = {
...
// Observability baseline configuration for stg environment
param observability = {
  logAnalytics: {
    prefix: 'dummyfin'
    resourceIndex: '001'
...
// Deployment toggles for stg environment
